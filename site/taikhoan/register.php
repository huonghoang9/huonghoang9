            ...
            <div class="form-group">
                <div class="form-check">
                    ...
                    <label style="float: right;">
                        Đã có tài khoản? <a href="index.php?act=login" style="color: #FB685C;">Đăng nhập</a>
                    </label>
                </div>
            </div>
            <button type="submit" name="submit" class="btn btn-primary" style="background-color: #FB685C;">Đăng ký</button>
        </form>
        <br>
    </div>
    <br>
